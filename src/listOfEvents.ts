...
export const ListOfEvents:ListOfEventsProps[] = [
    ...
    events: [
      {
        ...
        link: "https://www.instagram.com/p/DUB0_qokQq1/"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    events: [
      {
        id: "ev-ab-1",
        name: "XI Encontro Nacional de Motociclistas das Lages",
        icon: "moto",
        date: "10/04 a 12/04",
  ...
  },
  {
    ...
    events: [
      {
        id: "ev-jun-1",
        name: "XII Mostra de Artesanato e Cultura",
        icon: "arte",
        date: "04/06 a 07/06",
  ...
  },
  {
    ...
    events: [
      {
        id: "ev-jul-1",
        name: "45ª Exposição Agropecuária de Resende Costa",
        icon: "agropecuaria",
        date: "16/07 a 19/07",
      ...
      {
        id: "ev-jul-2",
        name: "4ª Encontro de Carros Antigos de Resende Costa",
        icon: "carro",
        date: "25/07 a 26/07",
